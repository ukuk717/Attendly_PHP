...
<section class="card">
  <form method="post" action="/admin/payslips/send" class="form" enctype="multipart/form-data" data-confirm-message="給与明細を送信します。よろしいですか？">
    ...
    <div class="form-field">
      <label for="summary">概要（任意）</label>
      <textarea name="summary" id="summary" rows="4" maxlength="500"></textarea>
    </div>
    <div class="form-field">
